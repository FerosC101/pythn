...
from Finance_Entry import get_amount, get_category, get_date, get_description
...
class CSV:
    ...
    def get_transaction(cls, start_date, end_date):
        ...
        if filtered_df.empty:
            ...
            print("\nSummary: ")
            print(f"Total Income: Php{total_income:.2f}")
...
def add():
    ...
    if date.lower() == "":
        ...
        date = datetime.strptime(date, CSV.FORMAT).strftime(CSV.FORMAT)
    amount = get_amount()
